    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuarios/me").hasAnyRole("ADMIN", "DENTISTA")
                        .requestMatchers(HttpMethod.PUT, "/usuarios/me/foto").hasAnyRole("ADMIN", "DENTISTA")
                        .requestMatchers(HttpMethod.DELETE, "/usuarios/me/foto").hasAnyRole("ADMIN", "DENTISTA")
                        .requestMatchers(HttpMethod.POST, "/usuarios/me/2fa/setup").hasAnyRole("ADMIN", "DENTISTA")
                        .requestMatchers(HttpMethod.POST, "/usuarios/me/2fa/confirm").hasAnyRole("ADMIN", "DENTISTA")
                        .requestMatchers(HttpMethod.DELETE, "/usuarios/me/2fa").hasAnyRole("ADMIN", "DENTISTA")
